...
import { Send, Loader2, MessageSquare, Search, Users } from 'lucide-react'
...
export default function InboxPage() {
  ...
  // If a member has no messages yet, still show them in the sidebar
      ...
      <div className="flex-1 flex flex-col">
        {selected ? (
          <>
            ...
            {/* Input */}
            <form onSubmit={sendMessage} className="p-4 border-t border-slate-800 flex gap-2 shrink-0">
              <input
                value={newMsg}
