...
export default function AgentChat() {
  ...
  const QUICK = [
    ...
    { icon: '⚠️', label: 'التأخيرات',    text: 'فيه تأخيرات؟ ادي تفاصيل مع المسؤولين' },
    { icon: '💰', label: 'الماليات',      text: 'ادي ملخص مالي: الإيرادات والمتأخر' },
    { icon: '👥', label: 'حمل الفريق',   text: 'عرض حمل كل عضو في الفريق وتاسكاته' },
  ]
