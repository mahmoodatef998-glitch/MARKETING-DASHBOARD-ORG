...
export default function AgentChat() {
  ...
  const [chat, setChat]             = useState<ChatMessage[]>([
    {
      role: 'assistant',
      text: 'أهلاً! أنا مديرك التنفيذي الذكي — خبرة 15 سنة تسويق.\n\n**صلاحياتي الكاملة:**\n• 📋 استيراد خطط المحتوى من Excel وإنشاء كل المهام تلقائياً\n• ⚠️ رصد التأخيرات وبعت إيميلات ذكية مخصصة للفريق\n• 📊 تقارير يومية + تقارير للعملاء مباشرة على إيميلهم\n• 🏥 تقييم صحة كل عميل وكشف المخاطر قبل ما تحصل\n• ⚖️ تحليل أعباء الفريق واقتراح إعادة توزيع ذكي\n• 💬 إشعارات مخصصة لكل شخص داخل السيستم\n• 🧠 ذاكرة دائمة بين الجلسات — بتذكر تفاصيلك\n• 📅 متابعة الاجتماعات وخطة النشر على المنصات\n\nارفع ملف Excel أو اكتب أمرك وأنا هنفذ فوراً.',
    },
  ])
  ...
  const QUICK = [
    { icon: '🏥', label: 'صحة العملاء',   text: 'حلل صحة كل عميل وكشف أي عميل في خطر' },
    { icon: '⚠️', label: 'التأخيرات',    text: 'فيه تأخيرات؟ حللها وابعت إيميلات ذكية للفريق' },
    { icon: '⚖️', label: 'أعباء الفريق', text: 'حلل أعباء الفريق — مين مثقّل ومين لديه طاقة فارغة' },
